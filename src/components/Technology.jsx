  ...
  return (
    <>
      <section className="home technology">
        <div className="px-5 pt-32 grid grid-cols-1 gap-5 lg:grid-cols-2  xl:max-w-7xl xl:mx-auto">
          <article className="pt-5 md:pt-10 xl:pt-32 text-center md:text-left">
            <h2 className="text-white text-3xl font-extralight  uppercase tracking-wider pb-5 md:pb-10">
              03
